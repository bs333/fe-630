...
```{r}
# 1. Pre-process the Data: Already done, moving to regression

# 2. Conduct the regressional analysis
...
# Creating a data frame from the results list for better visualization
